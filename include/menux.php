...
if ($section == "home")
	{
        $home_str = "<br><a class='menu3' href='http://highwire.atari-users.net/_TesT_/index.php?section=home?entry=welcome'>News</a> <a class='menu3' href='http://highwire.atari-users.net/_TesT_/index.php?section=home&entry=oldnews'>Archive</a>";
	} 
else if ($section == "dev")
{
